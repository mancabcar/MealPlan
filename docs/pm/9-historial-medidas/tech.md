...
5. [x] `LineChart` SVG (puntos por origen, `trend`/`connect`, modo compacto)
6. [x] `/perfil/evolucion`: estado vacío, resumen, gráfica del peso, historial y `Sheet` con «Solo peso» (R2, R7, R8, R11)
